...
map("x", "<C-S-j>", ":m '>+1<cr>gv=gv", { desc = "Move Down" })
map("x", "<C-S-k>", ":m '<-2<cr>gv=gv", { desc = "Move Up" })
...
map("n", "<C-g>d", "<cmd>tabclose<cr>", { desc = "Close Tab" })
map("n", "<C-g>o", "<cmd>tabonly<cr>", { desc = "Close Other Tab" })
map("n", "<C-g>n", "<cmd>tabnext<cr>", { desc = "Tab Next" })
map("n", "<C-g>p", "<cmd>tabprevious<cr>", { desc = "Tab Prev" })
map("n", "<C-g>c", "<cmd>tabnew<cr>", { desc = "Tab New" })
map("n", "<C-g>t", function()
  vim.cmd.tabnew()
  vim.cmd.term()
  vim.cmd.startinsert()
end, { desc = "Tab New with Term" })
